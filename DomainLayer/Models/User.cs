...
namespace Appdoptanos.Api.Models
{
    public class User
    {
        ...
        //Esto es necesario para hacer la inverse property
        public virtual ICollection<Adopcion> RescatistaUser { get; set; }
        public virtual ICollection<Adopcion> AdoptanteUser { get; set; }



        ////FK a nivel bd
        //public int Tipo_UserId { get; set; }
        ////Relacion a nivel objeto
        //public Tipo_UserDTO Tipo_User { get;set }
    }
}
